...
public class NacionalDpsSerializationTests
{
    ...
    // ==========================================================
    // FillingVariations — comprehensive XSD validation
    // ==========================================================
    ...
    {
        // Act
        var serializationResult = _sut.Serialize(document);

        // Assert
        serializationResult.Xml.ShouldBeValidAgainstDpsSchema();
        serializationResult.Xml.ShouldNotBeNullOrEmpty($"Scenario '{scenarioName}' produced null or empty XML.");
    }
